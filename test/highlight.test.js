...
`,
  ...
  {
    name: "expression operators differ from quoted literals and the wildcard",
    languages: ["posix_bre"],
  ...
  {
    name: "subexpressions own their delimiters and back-references are symbols",
    languages: ["posix_bre"],
    source: String.raw`\(a\)\1`,
    captures: [
      [0, 2, "punctuation.bracket"],
  ...
  {
    name: "an opening bracket range endpoint retains its element capture",
    languages: ["posix_bre", "posix_ere"],
    source: "[a-[]",
    captures: [
      [0, 1, "punctuation.bracket"],
  ...
  {
    name: "a collating symbol meta character retains its element capture",
    languages: ["posix_bre", "posix_ere"],
    source: "[[.].]]",
    captures: [
      [0, 2, "punctuation.bracket"],
